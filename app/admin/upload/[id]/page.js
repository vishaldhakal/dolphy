...
export default function Update({ params }) {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://api.dolphy.ca/api/preconstructions/" + params.id + "/")
      .then((res) => {
        setPredata(res.data);
      })
      .catch((err) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(
        `https://api.dolphy.ca/api/preconstructions/${predata.id}/`,
        alldata,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const handleDeleteUploadedImage = (image) => {
    swal({
      ...
      if (willDelete) {
        axios
          .delete(`https://api.dolphy.ca/api/delete-image/${image.id}/`)
          .then((res) => {
            console.log(res.data);
            setRefetch(!refetch);
  ...
  const handleDeleteUploadedPlan = (plan) => {
    swal({
      ...
      if (willDelete) {
        axios
          .delete(`https://api.dolphy.ca/api/delete-floorplan/${plan.id}/`)
          .then((res) => {
            console.log(res.data);
            setRefetch(!refetch);
